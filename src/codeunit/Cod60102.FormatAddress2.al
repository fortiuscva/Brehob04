codeunit 60102 "Format Address 2"
{
    ...
    begin
        ...
        if Country."Address Format" = Country."Address Format"::Custom then begin
            ...
            case Country."Address Format" of
                Country."Address Format"::"Post Code+City", Country."Address Format"::"City+County+Post Code", Country."Address Format"::"City+County+New Line+Post Code", Country."Address Format"::"Post Code+City+County", Country."Address Format"::"City+Post Code":
    ...
    begin
        ...
        case true of
            ...
            (Cont.Type = Cont.Type::Person) and (Cont."Company No." <> '') and (CompanyAltAddressCode <> '') and RMSetup."Inherit Address Details" and ContIdenticalAddress:
                begin
                    //with ContAltAddr do begin
                    ContAltAddr.Get(Cont."Company No.", CompanyAltAddressCode);
                    FormatAddr(AddrArray, ContAltAddr."Company Name", ContAltAddr."Company Name 2", Cont.Name, ContAltAddr.Address, ContAltAddr."Address 2", ContAltAddr.City, ContAltAddr."Post Code", ContAltAddr.County, ContAltAddr."Country/Region Code");
                end;
            (Cont.Type = Cont.Type::Person) and (Cont."Company No." <> ''):
            ...
            if CustomAddressFormat.FindSet() then
                repeat
                    case CustomAddressFormat."Field ID" of
                        ...
                        CompanyInfo.FieldNo("Country/Region Code"):
                            AddrArray[CustomAddressFormat."Line Position" + 1] := Country.Name;
                        CompanyInfo.FieldNo("Phone No."):
                            AddrArray[CustomAddressFormat."Line Position" + 1] := PhoneNo;
                        else
                            GenerateCustomPostCodeCity(AddrArray[CustomAddressFormat."Line Position" + 1], City, PostCode, County, Country);
                    end;
                until CustomAddressFormat.Next() = 0;
